...
class cosStor:
    ...
    def __init__(self, cosBucket="cosstor",cosFile="cosStor.json", secretId=None, secretKey=None, region=None, token=None, appid=None):
        ...
        self.cosConfig = CosConfig(Region=self.region, Appid=self.appid, Secret_id=self.secretId,
                                   Secret_key=self.secretKey, Token=self.token, Scheme='https')
    ...
    def get(self, key, default=None):
        self.load()
        if key not in self.storageData.keys():
            return default
